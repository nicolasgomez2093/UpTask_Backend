...
const agregarTarea = async (req, res) => {
    ...
    if (proyecto.length === 12 || proyecto.length === 24) {
    } else {
...
const obtenerTarea = async (req, res) => {
    ...
    const tarea = await Tarea.findById(id).populate("proyecto")  //Usamos populate para traer los datos asociados al proyecto
